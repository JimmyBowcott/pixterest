        ...
        return (
          <div className="flex flex-wrap justify-around items-center bg-pale-yellow text-pink-red h-screen pt-20 px-6 md:px-10 lg:px-20">
            <div className="relative max-h-[450px] max-w-[400px] lg:max-h-[570px] lg:max-w-[550px] h-full w-full -mt-24 -mr-20 lg:mt-0 flex-shrink-0">
                ...
                <img style={{width: "30%", left: "58%"}} className="pixelated rounded-3xl absolute top-0 hidden md:block" src="src/assets/artwork/search/3.png" />
                <img style={{width: "30%", left: "52%"}} className="pixelated rounded-3xl absolute top-80 hidden lg:block" src="src/assets/artwork/search/1.png" />
            </div>
