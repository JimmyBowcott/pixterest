            ...
            <div className="relative max-h-[450px] max-w-[400px] lg:max-h-[570px] lg:max-w-[550px] h-full w-full -mt-24 -mr-20 lg:mt-0 flex-shrink-0">
                <Link to="/search?q=home office" tabIndex="-1">
                    <div className="absolute top-40 left-1/4 h-12 w-60 md:h-20 md:w-60 bg-white rounded-full z-30 flex flex-row items-center gap-4 px-6">
                        <img src="pixterest/assets/icons/search.png" className="pixelated h-6" alt="" />
                        <p className="text-2xl text-almost-black">home office</p>
                    </div>
                </Link>
                <img style={{width: "50%", left: "20%"}} className="pixelated rounded-3xl absolute top-16 z-20" src="pixterest/assets/artwork/search/2.png" />
                <img style={{width: "35%"}} className="pixelated rounded-3xl absolute top-36 left-0" src="pixterest/assets/artwork/search/4.png" />
                <img style={{width: "30%", left: "58%"}} className="pixelated rounded-3xl absolute top-0 hidden md:block" src="pixterest/assets/artwork/search/3.png" />
                <img style={{width: "30%", left: "52%"}} className="pixelated rounded-3xl absolute top-80 hidden lg:block" src="pixterest/assets/artwork/search/1.png" />
            </div>
