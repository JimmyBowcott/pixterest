...
const Tile = ({title, src}) => {
    ...
    return (
        <div className="flex flex-col relative h-auto rounded-2xl gap-1 cursor-pointer"
            ...
            style={{backgroundImage: `url(./pixterest/assets/artwork/today/${src}.png)`, backgroundSize: "cover", backgroundPosition: "center",
...
const TodayPage = () => {
    ...
    return (
        ...
        <div className="flex flex-col justify-center items-center pt-32 gap-2 w-full text-center">
            ...
            <div className="flex flex-col items-center justify-center mt-12 mb-8">
                <img src="pixterest/assets/icons/tick.png" className="pixelated w-8 h-8 mb-4"/>
